...
```shell 
docc convert MyNewPackage.docc --fallback-display-name MyNewPackage --fallback-catalog-identifier com.example.MyNewPackage --fallback-catalog-version 1 --additional-symbol-graph-dir .build --output-dir MyNewPackage.doccarchive
```
