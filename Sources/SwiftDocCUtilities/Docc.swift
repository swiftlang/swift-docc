...
private let subcommands: [ParsableCommand.Type] = [Docc.Convert.self, Docc.Preview.self, Docc.ProcessArchive.self, Docc._Index.self]
...
"""
#else
private let subcommands: [ParsableCommand.Type] = [Docc.Convert.self, Docc.ProcessArchive.self, Docc._Index.self]
private let usage: String = """
docc convert [<catalog-path>] [--additional-symbol-graph-dir <symbol-graph-dir>] [<other-options>]
"""
#endif
