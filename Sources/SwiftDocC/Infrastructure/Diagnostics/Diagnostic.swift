...
public struct Diagnostic {
    ...
    @available(*, deprecated, renamed: "summary") // remove after 5.10 is released
    ...
    @available(*, deprecated, renamed: "explanation") // remove after 5.10 is released
...
@available(*, deprecated, message: "Use 'DiagnosticConsoleWriter.formattedDescription(for:options:)' instead.") // remove after 5.10 is released
