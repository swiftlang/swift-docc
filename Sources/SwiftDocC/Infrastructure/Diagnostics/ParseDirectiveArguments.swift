...
extension BlockDirective {
    ...
    func arguments(diagnostics: inout [Diagnostic]) -> [String: Markdown.DirectiveArgument] {
        ...
        diagnostics.append(
            contentsOf: parseErrors.compactMap { error -> Diagnostic? in
                switch error {
                case let .duplicateArgument(name, firstLocation, duplicateLocation):
                    ...
                    guard
                        !diagnostics.reversed().contains(where: { diagnostic -> Bool in
                ...
                case let .missingExpectedCharacter(character, location):
                    ...
                    return Diagnostic(
                        ...
                        solutions: [
                            Solution(
                                summary: "Insert a '\(character) character",
                                replacements: [
                ...
                case let .unexpectedCharacter(character, location):
                    ...
                    return Diagnostic(
                        ...
                        solutions: [
                            Solution(
                                summary: "Remove the '\(character) character",
                                replacements: [
