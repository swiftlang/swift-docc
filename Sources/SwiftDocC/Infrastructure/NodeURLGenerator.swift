...
public struct NodeURLGenerator {
    ...
    public enum Path {
        ...
        @available(*, deprecated, renamed: "tutorialTableOfContents(name:)", message: "Use 'tutorialTableOfContents(name:)' instead. This deprecated API will be removed after 6.1 is released")
        ...
        public var stringValue: String {
            ...
            case .technology(let technologyName),
                 .tutorialTableOfContents(let technologyName):
