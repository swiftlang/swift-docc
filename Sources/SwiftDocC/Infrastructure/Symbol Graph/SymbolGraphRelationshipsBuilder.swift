...
struct SymbolGraphRelationshipsBuilder {
    ...
    static func addInheritedDefaultImplementation(
        ...
        if !context.configuration.externalMetadata.inheritDocs, let unifiedSymbol = inherited.unifiedSymbol, unifiedSymbol.documentedSymbol?.isDocCommentFromSameModule(symbolModuleName: moduleName) == false {
