...
struct SemanticAnalyzer: MarkupVisitor {
    ...
    init(source: URL?, context: DocumentationContext, catalog: DocumentationCatalog) {
        self.source = source
    ...
    mutating func visitDocument(_ document: Document) -> Semantic? {
        ...
        if topLevelChildren.isEmpty {
            guard let article = Article(from: document, source: source, for: catalog, in: context, problems: &problems) else {
    ...
    mutating func visitBlockDirective(_ blockDirective: BlockDirective) -> Semantic? {
        ...
        case Technology.directiveName:
            return Technology(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Volume.directiveName:
            return Volume(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Chapter.directiveName:
            return Chapter(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case TutorialReference.directiveName:
            return TutorialReference(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case ContentAndMedia.directiveName:
            return ContentAndMedia(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Intro.directiveName:
            return Intro(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case ImageMedia.directiveName:
            return ImageMedia(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case VideoMedia.directiveName:
            return VideoMedia(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Tutorial.directiveName:
            return Tutorial(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case TutorialArticle.directiveName:
            return TutorialArticle(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case XcodeRequirement.directiveName:
            return XcodeRequirement(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Assessments.directiveName:
            return Assessments(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case MultipleChoice.directiveName:
            return MultipleChoice(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Choice.directiveName:
            return Choice(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Justification.directiveName:
            return Justification(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case TutorialSection.directiveName:
            return TutorialSection(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Step.directiveName:
            return Step(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Resources.directiveName:
            return Resources(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Comment.directiveName:
            return Comment(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case DeprecationSummary.directiveName:
            return DeprecationSummary(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Metadata.directiveName:
            return Metadata(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Redirect.directiveName:
            return Redirect(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case DocumentationExtension.directiveName:
            return DocumentationExtension(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
        case Snippet.directiveName:
            ...
            _ = Snippet(from: blockDirective, source: source, for: catalog, in: context, problems: &problems)
            return nil
        default:
