...
extension Semantic.Analyses {
    ...
    public struct HasOnlySequentialHeadings<Parent: Semantic & DirectiveConvertible> {
        ...
        @discardableResult public func analyze(_ directive: BlockDirective, children: some Sequence<any Markup>, source: URL?, for _: DocumentationContext.Inputs, problems: inout [Problem]) -> [Heading] {
