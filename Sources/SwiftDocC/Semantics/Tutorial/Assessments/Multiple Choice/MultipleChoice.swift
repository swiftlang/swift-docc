...
public final class MultipleChoice: Semantic, DirectiveConvertible {
    ...
    public convenience init?(from directive: BlockDirective, source: URL?, for bundle: DocumentationBundle, featureFlags: FeatureFlags, problems: inout [Problem]) {
        ...
        let choices: [Choice]
        (choices, remainder) = Semantic.Analyses.ExtractAll<Choice>(featureFlags: featureFlags).analyze(directive, children: remainder, source: source, for: bundle, problems: &problems)
        ...
        (images, remainder) = Semantic.Analyses.ExtractAll<ImageMedia>(featureFlags: featureFlags).analyze(directive, children: remainder, source: source, for: bundle, problems: &problems)
