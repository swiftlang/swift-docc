...
public final class Article: Semantic, Abstracted, Redirected, AutomaticTaskGroupsProviding {
    ...
    public convenience init?(from markup: any Markup, source: URL?, for bundle: DocumentationContext.Inputs, featureFlags: FeatureFlags, diagnostics: inout [Diagnostic]) {
