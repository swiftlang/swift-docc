...
package enum StaticResources {
    ...
    static let referenceStyleSheet = File(
    ...
    static let apiCollectionIcon = File(
        filename: "api-collection.svg",
        data: Data(
            """
    ...
    static let articleIcon = File(
        filename: "article.svg",
        data: Data(
            """
