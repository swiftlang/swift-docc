...
## Building, Publishing, and Previewing Documentation with the DocC-Plugin
...
You can also use the DocC command-line interface as explained in <doc:distributing-documentation-to-other-developers>.
