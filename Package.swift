...
if ProcessInfo.processInfo.environment["SWIFTCI_USE_LOCAL_DEPS"] == nil {
    ...
    package.dependencies += [
        ...
        .package(name: "swift-markdown", url: "https://github.com/apple/swift-markdown.git", .branch("release/5.8-02062023")),
        .package(name: "CLMDB", url: "https://github.com/apple/swift-lmdb.git", .branch("main")),
        .package(url: "https://github.com/apple/swift-argument-parser", .upToNextMinor(from: "1.0.1")),
        .package(name: "SymbolKit", url: "https://github.com/apple/swift-docc-symbolkit", .branch("release/5.8-02062023")),
