...
if ProcessInfo.processInfo.environment["SWIFTCI_USE_LOCAL_DEPS"] == nil {
    ...
    package.dependencies += [
        ...
        .package(url: "https://github.com/swiftlang/swift-markdown.git", branch: "release/6.2-20250502"),
        .package(url: "https://github.com/swiftlang/swift-lmdb.git", branch: "release/6.2"),
        .package(url: "https://github.com/apple/swift-argument-parser.git", from: "1.2.2"),
        .package(url: "https://github.com/swiftlang/swift-docc-symbolkit.git", branch: "release/6.2-20250502"),
