...
class ConvertActionIndexerTests: XCTestCase {
    ...
    func testConvertActionIndexer() throws {
        ...
        do {
            let reference = ResolvedTopicReference(id: "org.swift.docc.example", path: "/documentation/MyKit", sourceLanguage: .swift)
        ...
        // and verify the tree.
        do {
            let reference1 = ResolvedTopicReference(id: "org.swift.docc.example", path: "/documentation/MyKit", sourceLanguage: .swift)
            let renderNode1 = try converter.convert(context.entity(with: reference1))

            let reference2 = ResolvedTopicReference(id: "org.swift.docc.example", path: "/documentation/Test-Bundle/Default-Code-Listing-Syntax", sourceLanguage: .swift)
