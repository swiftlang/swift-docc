...
class NearMissTests: XCTestCase {
    ...
    func testSwiftArgumentParserExamples() throws {
        ...
        checkBestMatches(
            for: argumentSubpaths, against: "init(wrappedValue:)",
            expectedMatches: [
                // These need to be in the best matches in this order.
                "init(wrappedValue:help:completion:)",
                "init(wrappedValue:parsing:help:completion:)",
        ...
        checkBestMatches(
            for: argumentSubpaths, against: "init(parsing:",
            expectedMatches: [
                // These need to be in the best matches in this order.
                "init(parsing:help:completion:)",
                "init(parsing:help:completion:transform:)",
    ...
    func testSwiftMarkdownExamples() throws {
        ...
        checkBestMatches(
            for: markupSubpaths, against: "child",
            expectedMatches: [
                // These need to be in the best matches in this order.
                "children",
                "child(at:)",
        ...
        checkBestMatches(
            for: markupVisitorSubpaths, against: "visitTable",
            expectedMatches: [
                // These need to be in the best matches in this order
                "visitTable(_:)",
                "visitTableRow(_:)",
        ...
        checkBestMatches(
            for: markupVisitorSubpaths, against: "visitBlock",
            expectedMatches: [
                // These need to be in the best matches in this order
                "visitBlockQuote(_:)",
                "visitBlockDirective(_:)",
    ...
    func testSwiftDocCExamples() throws {
        ...
        let allTopLevelSwiftDocCSymbols = [
            "AbsoluteSymbolLink", "AbstractContainsFormattedTextOnly", "AbstractSection", "AnchorSection", "AnyChecker", "AnyCodable", "AnyLink", "AnyMetadata", "Article", "Assessments", "AssetReference", "AttributedCodeListing", "AttributesRenderSection", "AutomaticCuration", "AutomaticSeeAlso", "AutomaticTitleHeading", "AvailabilityIndex", "AvailabilityRenderItem", "BasicDiagnostic", "Benchmark", "benchmark(add:benchmarkLog:)", "benchmark(begin:benchmarkLog:)", "benchmark(end:benchmarkLog:)",
            "benchmark(wrap:benchmarkLog:body:)", "BenchmarkBlockMetric", "BenchmarkMetric", "BenchmarkResult", "BenchmarkResults", "BuildMetadata", "BundleData", "BundleDiscoveryOptions", "BundleIdentifier", "CallToActionSection", "Chapter", "Checker", "Checksum", "ChildDirective", "ChildMarkup", "Choice", "CodableContentSection", "Code", "CodeColors", "CodeColorsPreferenceKey", "CodeExample", "Comment", "CommunicationBridge", "CommunicationBridgeError", "CompositeChecker",
            "ConformanceSection", "ContentAndMedia", "ContentAndMediaGroupSection", "ContentAndMediaSection", "ContentLayout", "ContentRenderSection", "Converter", "ConvertOutputConsumer", "ConvertRequest", "ConvertRequestContextWrapper", "ConvertResponse", "ConvertService", "ConvertServiceError", "CoverageDataEntry", "CursorRange", "CustomMetadata", "DataAsset", "DataTraitCollection", "DeclarationRenderSection", "DeclarationsRenderSection", "DefaultAvailability",
            "DefaultImplementationsSection", "DeprecatedSection", "DeprecationSummary", "DescribedError", "Diagnostic", "DiagnosticConsoleWriter", "DiagnosticConsumer", "DiagnosticEngine", "DiagnosticFormattingConsumer", "DiagnosticFormattingOptions", "DiagnosticNote", "DiagnosticSeverity", "DiffAvailability", "DirectiveArgumentWrapped", "DirectiveConvertible", "DiscussionSection", "DisplayName", "DocCSymbolRepresentable", "DocumentationBundle", "DocumentationBundleFileTypes",
            "DocumentationContentRenderer", "DocumentationContext", "DocumentationContextConverter", "DocumentationContextDataProvider", "DocumentationContextDataProviderDelegate", "DocumentationConverter", "DocumentationConverterProtocol", "DocumentationCoverageLevel", "DocumentationCoverageOptions", "DocumentationNode", "DocumentationNodeConverter", "DocumentationSchemeHandler", "DocumentationServer", "DocumentationServerError", "DocumentationServerProtocol", "DocumentationService",
            "DocumentationWorkspace", "DownloadReference", "DuplicateTopicsSections", "DynamicallyIdentifiableMetric", "EnglishLanguage", "ErrorsEncountered", "ErrorWithProblems", "ExternalIdentifier", "ExternalMetadata", "ExternalReferenceResolver", "ExternalSymbolResolver", "FallbackAssetResolver", "FallbackReferenceResolver", "FeatureFlags", "FileReference", "FileServer", "FileServerProvider", "FileSystemProvider", "FileSystemRenderNodeProvider", "FileSystemServerProvider",
            "FileTypeReference", "FSNode", "GeneratedDataProvider", "GroupedSection", "ImageMedia", "ImageReference", "Implementation", "ImplementationsGroup", "Indexable", "IndexingError", "IndexingRecord", "InterfaceLanguage", "Intro", "IntroRenderSection", "InvalidAdditionalTitle", "JSONPatch", "JSONPatchOperation", "JSONPointer", "Justification", "Landmark", "Layout", "LineHighlighter", "LinkDestinationSummary", "LinkReference", "Links", "LMDBData", "LogHandle", "MarkupContainer",
            "MarkupConvertible", "MarkupLayout", "Media", "MediaReference", "MemoryFileServerProvider", "Message", "MessageType", "Metadata", "MetricValue", "MissingAbstract", "MultipleChoice", "NativeLanguage", "NavigatorIndex", "NavigatorItem", "NavigatorTree", "NodeURLGenerator", "NonInclusiveLanguageChecker", "NonOverviewHeadingChecker", "Options", "OutOfProcessReferenceResolver", "PageImage", "Parameter", "ParameterRenderSection", "ParametersRenderSection", "ParametersSection", "Platform",
            "PlatformName", "PlatformVersion", "PossibleValuesRenderSection", "PresentationURLGenerator", "PrintCursor", "Problem", "PropertiesRenderSection", "Redirect", "Relationship", "RelationshipsGroup", "RelationshipsRenderSection", "RelationshipsSection", "RemoveAutomaticallyCuratedSeeAlsoSectionsTransformation", "RemoveHierarchyTransformation", "RemoveUnusedReferencesTransformation", "RenderAttribute", "RenderBlockContent", "RenderContentMetadata", "RenderContext", "RenderHierarchy",
            "RenderHierarchyChapter", "RenderHierarchyLandmark", "RenderHierarchyTutorial", "RenderIndex", "RenderInlineContent", "RenderJSONDecoder", "RenderJSONEncoder", "RenderMetadata", "RenderNode", "RenderNodeDataExtractor", "RenderNodeProvider", "RenderNodeTransformation", "RenderNodeTransformationComposition", "RenderNodeTransformationContext", "RenderNodeTransformer", "RenderNodeTransforming", "RenderNodeTranslator", "RenderProperty", "RenderReference", "RenderReferenceCache",
            "RenderReferenceDependencies", "RenderReferenceIdentifier", "RenderReferenceStore", "RenderReferenceType", "RenderRelationshipsGroup", "RenderSection", "RenderSectionKind", "RenderTile", "RenderTree", "Replacement", "ResourceReference", "Resources", "ResourcesRenderSection", "RESTEndpointRenderSection", "Return", "ReturnsSection", "Row", "SampleDownloadSection", "Section", "SeeAlsoInTopicsHeadingChecker", "SeeAlsoSection", "Semantic", "SemanticAnalysis", "SemanticVersion",
            "SemanticVisitor", "SemanticWalker", "Serializable", "shouldPrettyPrintOutputJSON", "SimpleTag", "Small", "Snippet", "Solution", "SourceRepository", "SRGBColor", "Stack", "Step", "Steps", "Symbol", "SymbolReference", "Synchronized", "TabNavigator", "TaskGroup", "TaskGroupRenderSection", "Technology", "TechnologyBound", "TextIndexing", "Throw", "Tile", "TitleStyle", "TopicImage", "TopicReference", "TopicReferenceSchemeHandler", "TopicRenderReference", "TopicsSection",
            "TopicsSectionWithoutSubheading", "TopicsVisualStyle", "Tutorial", "TutorialArticle", "TutorialArticleSection", "TutorialAssessmentsRenderSection", "TutorialReference", "TutorialSection", "TutorialSectionsRenderSection", "TypeDetails", "UnresolvedCodeListingReference", "UnresolvedRenderReference", "URLReference", "ValidatedURL", "VariantCollection", "VariantContainer", "VariantOverride", "VariantOverrides", "VariantPatchOperation", "VideoMedia", "VideoReference", "Volume",
            "VolumeRenderSection", "WebKitCommunicationBridge", "XcodeRequirement", "XcodeRequirementReference",
        ]

        checkBestMatches(
            for: allTopLevelSwiftDocCSymbols, against: "DocumentationConte",
            expectedMatches: [
                // These need to be in the best matches in this order
        ...
        checkBestMatches(
            for: allTopLevelSwiftDocCSymbols, against: "Convert",
            expectedMatches: [
                // These need to be in the best matches in this order.
                "Converter",
                "ConvertRequest",
        ...
        checkBestMatches(
            for: allTopLevelSwiftDocCSymbols, against: "RenderJSONCoder",
            expectedMatches: [
                // These need to be in the best matches in this order
                "RenderJSONDecoder",
                "RenderJSONEncoder",
        ...
        checkBestMatches(
            for: allTopLevelSwiftDocCSymbols, against: "Diagnostic",
            expectedMatches: [
                // These need to be in the best matches in this order.
                "Diagnostic",
                "DiagnosticNote",
    ...
    func checkBestMatches(
        ...
        XCTAssertEqual(
            matchesSuffix, filteredAcceptedMatches,
            """
