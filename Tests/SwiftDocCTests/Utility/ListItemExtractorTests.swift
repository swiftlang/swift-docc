...
class ListItemExtractorTests: XCTestCase {
    ...
    func assertExtractsRichContentFor(
        ...
        try _assertExtractsRichContentFor(
            tagName: tagName, findModelContent: findModelContent, renderVerification: renderVerification, isAside: isAside, context: context,
            expectedLogText: """
    ...
    func assertExtractsRichContentOutlineFor(
        ...
        try _assertExtractsRichContentFor(
            tagName: tagName, findModelContent: findModelContent, renderVerification: renderVerification, isAside: false, context: context,
            expectedLogText: """
                \u{001B}[1;33mwarning: 'FirstNotFoundSymbol' doesn't exist at '/ModuleName'\u{001B}[0;0m
