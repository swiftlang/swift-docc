...
class IndexingTests: XCTestCase {
    ...
    func testTutorial() async throws {
        ...
        var converter = RenderNodeTranslator(context: context, inputs: inputs, identifier: tutorialReference)
    ...
    func testArticle() async throws {
        ...
        var converter = RenderNodeTranslator(context: context, inputs: inputs, identifier: articleReference)
