...
class DocumentationBundleFileTypesTests: XCTestCase {
    func testIsCustomHeader() {
        XCTAssertTrue(
            DocumentationBundleFileTypes.isCustomHeader(
    ...
    func testIsCustomFooter() {
        XCTAssertTrue(
            DocumentationBundleFileTypes.isCustomFooter(
                URL(fileURLWithPath: "footer.html")))
        XCTAssertTrue(
            DocumentationBundleFileTypes.isCustomFooter(
                URL(fileURLWithPath: "/footer.html")))
    ...
    func testIsThemeSettingsFile() {
        XCTAssertTrue(
            DocumentationBundleFileTypes.isThemeSettingsFile(
    ...
    func testIsCustomFavicon() {
        XCTAssertTrue(
            DocumentationBundleFileTypes.isCustomFavicon(
