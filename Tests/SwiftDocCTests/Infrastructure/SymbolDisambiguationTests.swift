...
class SymbolDisambiguationTests: XCTestCase {
    ...
    func testDifferentSymbolsWithDifferentKindsInDifferentLanguages() async throws {
        ...
        XCTAssertEqual(
            references[SymbolGraph.Symbol.Identifier(precise: "second", interfaceLanguage: "objective-c")]?.path,
    ...
    func testMixedLanguageFramework() async throws {
        ...
        XCTAssertEqual(
            references[.init(precise: "c:@CM@TestFramework@objc(cs)MixedLanguageClassConformingToProtocol(im)mixedLanguageMethod", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/MixedLanguageClassConformingToProtocol/mixedLanguageMethod()")
        XCTAssertEqual(
            references[.init(precise: "c:@E@Foo", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Foo-swift.struct")
        XCTAssertEqual(
            references[.init(precise: "c:@E@Foo@first", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Foo-swift.struct/first")
        XCTAssertEqual(
            references[.init(precise: "c:@E@Foo@fourth", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Foo-swift.struct/fourth")
        XCTAssertEqual(
            references[.init(precise: "c:@E@Foo@second", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Foo-swift.struct/second")
        XCTAssertEqual(
            references[.init(precise: "c:@E@Foo@third", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Foo-swift.struct/third")
        XCTAssertEqual(
            references[.init(precise: "c:@M@TestFramework@objc(cs)MixedLanguageClassConformingToProtocol", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/MixedLanguageClassConformingToProtocol")
        XCTAssertEqual(
            references[.init(precise: "c:@M@TestFramework@objc(cs)MixedLanguageClassConformingToProtocol(im)init", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/MixedLanguageClassConformingToProtocol/init()")
        XCTAssertEqual(
            references[.init(precise: "c:@M@TestFramework@objc(pl)MixedLanguageProtocol", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/MixedLanguageProtocol")
        XCTAssertEqual(
            references[.init(precise: "c:@M@TestFramework@objc(pl)MixedLanguageProtocol(im)mixedLanguageMethod", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/MixedLanguageProtocol/mixedLanguageMethod()")
        XCTAssertEqual(
            references[.init(precise: "c:@MixedLanguageFrameworkVersionNumber", interfaceLanguage: "occ")],
            "/documentation/MixedLanguageFramework/_MixedLanguageFrameworkVersionNumber")
        XCTAssertEqual(
            references[.init(precise: "c:@MixedLanguageFrameworkVersionString", interfaceLanguage: "occ")],
            "/documentation/MixedLanguageFramework/_MixedLanguageFrameworkVersionString")
        XCTAssertEqual(
            references[.init(precise: "c:MixedLanguageFramework.h@T@Foo", interfaceLanguage: "occ")],
            "/documentation/MixedLanguageFramework/Foo-c.typealias")
        XCTAssertEqual(
            references[.init(precise: "c:objc(cs)Bar", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Bar")
        XCTAssertEqual(
            references[.init(precise: "c:objc(cs)Bar(cm)myStringFunction:error:", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/Bar/myStringFunction(_:)")
        XCTAssertEqual(
            references[.init(precise: "s:22MixedLanguageFramework15SwiftOnlyClassV", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/SwiftOnlyClass")
        XCTAssertEqual(
            references[.init(precise: "s:22MixedLanguageFramework15SwiftOnlyStructV", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/SwiftOnlyStruct")
        XCTAssertEqual(
            references[.init(precise: "s:22MixedLanguageFramework15SwiftOnlyStructV4tadayyF", interfaceLanguage: "swift")],
            "/documentation/MixedLanguageFramework/SwiftOnlyStruct/tada()")
        XCTAssertEqual(
            references[.init(precise: "s:So3FooV8rawValueABSu_tcfc", interfaceLanguage: "swift")],
