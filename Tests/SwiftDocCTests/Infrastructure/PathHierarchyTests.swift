...
class PathHierarchyTests: XCTestCase {
    ...
    func testTestBundle() throws {
        ...
        let parentID = linkResolver.resolvedReferenceMap[ResolvedTopicReference(bundleIdentifier: bundle.id.rawValue, path: "/documentation/MyKit", sourceLanguage: .swift)]!
