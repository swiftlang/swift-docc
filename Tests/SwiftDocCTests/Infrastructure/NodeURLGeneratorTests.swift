...
class NodeURLGeneratorTests: XCTestCase {
    ...
    func testSafeURLWithBaseURL() throws {
        ...
        let basicIdentifier = ResolvedTopicReference(
            bundleID: "com.example.testbundle",
        ...
        let symbolIdentifier = ResolvedTopicReference(
            bundleID: "com.example.testbundle",
            path: "/folder/class/.==",
            fragment: nil,
            sourceLanguage: .swift)
        ...
        let privateIdentifier = ResolvedTopicReference(
            bundleID: "com.example.testbundle",
        ...
        let classIdentifier = ResolvedTopicReference(
            bundleID: "com.example.testbundle",
