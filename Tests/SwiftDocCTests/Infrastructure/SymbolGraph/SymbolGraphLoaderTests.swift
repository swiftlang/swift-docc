...
struct SymbolGraphLoaderTests {
    ...
    func appliesTransformationToLoadedSymbolGraph() throws {
        ...
        var loader = SymbolGraphLoader(inputs: inputs, dataProvider: dataProvider, shouldCreateOverloadGroups: false) { symbolGraph in
    ...
    private func makeLoader(@FileBuilder content: () -> [any File]) throws -> SymbolGraphLoader {
        ...
        return SymbolGraphLoader(inputs: inputs, dataProvider: dataProvider, shouldCreateOverloadGroups: false)
    }
}
