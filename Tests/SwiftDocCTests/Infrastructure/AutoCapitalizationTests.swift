...
class AutoCapitalizationTests: XCTestCase {
    ...
    func testParametersCapitalization() async throws {
        ...
        let reference = ResolvedTopicReference(bundleID: inputs.id, path: "/documentation/ModuleName/functionName(...)", sourceLanguage: .swift)
        ...
        var renderNodeTranslator = RenderNodeTranslator(context: context, inputs: inputs, identifier: reference)
