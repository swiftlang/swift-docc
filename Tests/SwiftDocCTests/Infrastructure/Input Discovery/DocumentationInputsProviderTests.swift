    ...
    func testDiscoversSameFilesAsPreviousImplementation() throws {
        ...
        for fileManager in [FileManager.default as (any FileManagerProtocol), testFileSystem as (any FileManagerProtocol)] {
            ...
            let options = BundleDiscoveryOptions(
                fallbackIdentifier: "com.example.test",
            ...
            XCTAssertEqual(
                bundle.markupURLs.map(relativePathString).sorted(),
                [
                    "Found.docc/CCC.md",
            ...
            XCTAssertEqual(
                bundle.miscResourceURLs.map(relativePathString).sorted(),
                [
            ...
            XCTAssertEqual(
                bundle.symbolGraphURLs.map(relativePathString).sorted(),
                [
