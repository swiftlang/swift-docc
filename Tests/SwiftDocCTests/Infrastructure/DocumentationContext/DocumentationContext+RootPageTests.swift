...
class DocumentationContext_RootPageTests: XCTestCase {
    ...
    func testMixedRootTypesWarning() throws {
        ...
        XCTAssertEqual(mixedRootsWarning?.diagnostic.summary, "Documentation has both symbol graph modules and manual technology roots")
    ...
    func testMultipleTechnologyRootsWarning() throws {
        ...
        XCTAssertNotNil(multipleTechRootsWarning, "Should emit warning about multiple technology roots")
        XCTAssertEqual(multipleTechRootsWarning?.diagnostic.summary, "Documentation has multiple manual technology roots")
