...
class SemaToRenderNodeTests: XCTestCase {
    func testCompileTutorial() throws {
        ...
        XCTAssertEqual(renderNode.identifier, ResolvedTopicReference(id: "org.swift.docc.example", path: "/tutorials/Test-Bundle/TestTutorial", sourceLanguage: .swift))
    ...
    func testTutorialBackgroundComesFromImageOrVideoPoster() throws {
        ...
        func assertTutorialWithPath(_ tutorialPath: String, hasBackground backgroundIdentifier: String) throws {
            let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: tutorialPath, sourceLanguage: .swift))
    ...
    private func assertCompileOverviewWithNoVolumes(bundle: DocumentationBundle, context: DocumentationContext, expectedProblemsCount: Int = 0) throws {
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/tutorials/TestOverview", sourceLanguage: .swift))
    ...
    func testCompileSymbol() throws {
        ...
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyProtocol", sourceLanguage: .swift))
    ...
    func testCompileSymbolWithExternalReferences() throws {
        class TestSymbolResolver: GlobalExternalSymbolResolver {
            func symbolReferenceAndEntity(withPreciseIdentifier preciseIdentifier: String) -> (ResolvedTopicReference, LinkResolver.ExternalEntity)? {
                let reference = ResolvedTopicReference(id: "com.test.external.symbols", path: "/\(preciseIdentifier)", sourceLanguage: .objectiveC)
    ...
    func testRenderConstraints() throws {
        ...
        let parent = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyClass", sourceLanguage: .swift))
    ...
    func testMediaReferencesWithSpaces() throws {
        let (bundle, context) = try testBundleAndContext(named: "TestBundle")
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/tutorials/Test-Bundle/TutorialMediaWithSpaces", sourceLanguage: .swift))
...
""",
        ...
        let (bundle, context) = try testBundleAndContext(named: "TestBundle")
        var contentTranslator = RenderContentCompiler(context: context, bundle: bundle, identifier: ResolvedTopicReference(id: bundle.id, path: "/TestTutorial", sourceLanguage: .swift))
...
""",
    ...
    """
        ...
        let node = DocumentationNode(reference: ResolvedTopicReference(id: "org.swift.docc", path: "/blah", sourceLanguage: .swift), kind: .article, sourceLanguage: .swift, name: .conceptual(title: "Title"), markup: document, semantic: Semantic())
        let (bundle, context) = try testBundleAndContext(named: "TestBundle")
        var translator = RenderNodeTranslator(context: context, bundle: bundle, identifier: node.reference)
    ...
    private func renderNodeForArticleInTestBundle(content: String) throws -> RenderNode {
        ...
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/Test-Bundle/article2", sourceLanguage: .swift))
    ...
    */
    ...
    func testRendersBetaViolators() throws {
        func makeTestBundle(currentPlatforms: [String : PlatformVersion]?, file: StaticString = #file, line: UInt = #line) throws -> (DocumentationBundle, DocumentationContext, ResolvedTopicReference) {
            ...
            let reference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyClass", sourceLanguage: .swift)
    ...
    func testRendersDeprecatedViolator() throws {
        ...
        do {
            let reference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyClass/myFunction()", sourceLanguage: .swift)
            let node = try context.entity(with: reference)
            (node.semantic as? Symbol)?.availability = SymbolGraph.Symbol.Availability(availability: [
    ...
    func testDefaultImplementations() throws {
        ...
        do {
            let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/SideKit/SideProtocol", sourceLanguage: .swift))
            let symbol = node.semantic as! Symbol
            var translator = RenderNodeTranslator(context: context, bundle: bundle, identifier: node.reference)
            let renderNode = translator.visit(symbol) as! RenderNode
        ...
        do {
            let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/SideKit/SideProtocol/func()", sourceLanguage: .swift))
            let symbol = node.semantic as! Symbol
            var translator = RenderNodeTranslator(context: context, bundle: bundle, identifier: node.reference)
            let renderNode = translator.visit(symbol) as! RenderNode
    ...
    func testDocumentationRenderReferenceRoles() throws {
        // Check for fragments in metadata in render node
        let (bundle, context) = try testBundleAndContext(named: "TestBundle")
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit", sourceLanguage: .swift))
    ...
    func testRemovingTrailingNewLinesInDeclaration() throws {
        ...
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/globalFunction(_:considering:)", sourceLanguage: .swift))
        let symbol = node.semantic as! Symbol
    ...
    func testRenderManualSeeAlsoInArticles() throws {
        // Check for fragments in metadata in render node
        let (bundle, context) = try testBundleAndContext(named: "TestBundle")
        let node = try context.entity(with: ResolvedTopicReference(id: bundle.id, path: "/documentation/Test-Bundle/article", sourceLanguage: .swift))
    ...
    func testDuplicateNavigatorTitleIsRemoved() throws {
        ...
        let myFuncReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/globalFunction(_:considering:)", sourceLanguage: .swift)
    ...
    func testNonDuplicateNavigatorTitleIsRendered() throws {
        ...
        let myFuncReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyProtocol", sourceLanguage: .swift)
        let node = try context.entity(with: myFuncReference)
        let symbol = node.semantic as! Symbol
    ...
    func testRenderAsides() throws {
        ...
        let dashReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/Asides/dashAsides()", sourceLanguage: .swift)
        let quoteReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/Asides/quoteAsides()", sourceLanguage: .swift)
    ...
    func testOriginMetadata() throws {
        ...
        let myFuncReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/SideKit/SideClass/Element/inherited()", sourceLanguage: .swift)
        let node = try context.entity(with: myFuncReference)
        let symbol = try XCTUnwrap(node.semantic as? Symbol)
    ...
    func testNonDocumentedSymbolNilAbstract() throws {
        ...
        let reference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/globalFunction(_:considering:)", sourceLanguage: .swift)
        let node = try context.entity(with: reference)
        let symbol = try XCTUnwrap(node.semantic as? Symbol)
    ...
    func testCustomSymbolDisplayNames() throws {
        ...
        let protocolReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyProtocol", sourceLanguage: .swift)
        let functionReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/MyKit/MyClass/myFunction()", sourceLanguage: .swift)
    ...
    func testInheritedAPIGroupsInCollidedParents() throws {
        ...
        let inheritedSymbolReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/Minimal_docs/A/B-swift.struct/!=(_:_:)", sourceLanguage: .swift)
        ...
        let equatableImplementationsReference = ResolvedTopicReference(id: bundle.id, path: "/documentation/Minimal_docs/A/B-swift.struct/Equatable-Implementations", sourceLanguage: .swift)
    ...
    func testAutomaticCurationForRefinedSymbols() throws {
        ...
        do {
            let reference = ResolvedTopicReference(id: bundle.id, path: "/documentation/GeometricalShapes/Circle", sourceLanguage: .swift)
            let node = try context.entity(with: reference)
    ...
    func testThematicBreak() throws {
        ...
        var contentTranslator = RenderContentCompiler(context: context, bundle: bundle, identifier: ResolvedTopicReference(id: bundle.id, path: "/TestThematicBreak", sourceLanguage: .swift))
