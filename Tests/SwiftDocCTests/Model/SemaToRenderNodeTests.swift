...
class SemaToRenderNodeTests: XCTestCase {
    func testCompileTutorial() async throws {
        ...
        do {
            ...
            guard case let .contentAndMedia(section) = contentSection,
                ...
                importantAside.style == .init(rawValue: "Important")
            else {
            ...
            guard case let .paragraph(notePara)? = noteContent.first,
                ...
                case let .text(noteText)? = notePara.inlineContent.first
            else {
            ...
            guard case let .paragraph(importantPara)? = importantContent.first,
                ...
                case let .text(importantText)? = importantPara.inlineContent.first
            else {
        ...
        XCTAssertNotNil(
            imageReference.asset.variants.first(where: { traits in
        ...
        XCTAssertNotNil(
            introVideoReference.asset.variants.first(where: { traits in
                return traits.key.userInterfaceStyle == .some(.light)
            }))
        XCTAssertNotNil(
            introVideoReference.asset.variants.first(where: { traits in
        ...
        XCTAssertNil(
            stepImageReference.asset.variants.first(where: { traits in
                return traits.key.userInterfaceStyle == .some(.dark)
            }))
        ...
        XCTAssertEqual(
            helloworld1FileReference.content,
            [
                "func foo() {",
                "",
                "}",
        ...
        XCTAssertEqual(
            helloworld2FileReference.content,
            [
                "func foo() {",
                "  print(\"1\")",
                "  print(\"2\")",
        ...
        XCTAssertEqual(
            helloworld3FileReference.content,
            [
                "func foo() {",
                "  print(\"1\")",
                "  print(\"2\")",
        ...
        XCTAssertEqual(
            helloworld4FileReference.content,
            [
                "func foo() {",
                "  print(\"1\")",
                "  print(\"2\")",
    ...
    private func assertCompileOverviewWithNoVolumes(bundle: DocumentationBundle, context: DocumentationContext, expectedDiagnosticsCount: Int = 0) throws {
        ...
        XCTAssertEqual(
            ...
            RenderInlineContent.reference(
                identifier: RenderReferenceIdentifier("doc://org.swift.docc.example/tutorials/Test-Bundle/TestTutorial"),
                isActive: true,
    ...
    func testCompileSymbol() async throws {
        ...
        guard
            let languageTrait = renderNode.variants?.first?.traits.first(where: { trait -> Bool in
        ...
        XCTAssertEqual(
            renderNode.relationshipSections[1].identifiers,
            [
        ...
        XCTAssertEqual(
            groupDiscussionParagraphPrefixes,
            [
        ...
        XCTAssertTrue(
            discussion.content.last.map { block -> Bool in
                switch block {
        ...
        XCTAssertTrue(
            renderNode.topicSections[0].identifiers.allSatisfy({ identifier -> Bool in
        ...
        XCTAssertTrue(
            Array(renderNode.seeAlsoSections[0].identifiers.prefix(3)).allSatisfy({ identifier -> Bool in
                return identifier == "doc://org.swift.docc.example/documentation/MyKit/MyClass"
            }))
        ...
        // },
        XCTAssertNil(
            renderNode.references.first(where: { (key, value) -> Bool in
    ...
    func testRenderConstraints() async throws {
        ...
        XCTAssertEqual(
            conf.constraints.map { el -> String in
                switch el {
        ...
        XCTAssertEqual(
            functionReference.conformance?.constraints.map { el -> String in
                switch el {
                case .text(let text): return text
                case .codeVoice(let text): return text
                default: return ""
    ...
    func testRenderConditionalConstraintsOnConformingType() async throws {
        ...
        XCTAssertEqual(
            myClassRelationship.conformance?.constraints.map { el -> String in
                switch el {
                case .text(let text): return text
                case .codeVoice(let text): return text
                default: return ""
    ...
    func testRenderConditionalConstraintsOnProtocol() async throws {
        ...
        XCTAssertEqual(
            myProtocolRelationship.conformance?.constraints.map { el -> String in
                switch el {
                case .text(let text): return text
                case .codeVoice(let text): return text
                default: return ""
    ...
    func testRenderReferenceResolving() async throws {
        ...
        XCTAssertEqual(
            renderNode.topicSections[0].identifiers.sorted(),
            [
        ...
        XCTAssertEqual(
            renderNode.topicSections[1].identifiers.sorted(),
            [
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-33vaw",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-3743d",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/myFunction()",
        ...
        XCTAssertEqual(
            renderNode.topicSections[2].identifiers.sorted(),
            [
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-33vaw",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-3743d",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/myFunction()",
        ...
        XCTAssertEqual(
            renderNode.topicSections[3].identifiers.sorted(),
            [
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-33vaw",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-3743d",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/myFunction()",
        ...
        XCTAssertEqual(
            renderNode.topicSections[4].identifiers.sorted(),
            [
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-33vaw",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-3743d",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/myFunction()",
        ...
        XCTAssertEqual(
            renderNode.topicSections[5].identifiers.sorted(),
            [
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-33vaw",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-3743d",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/myFunction()",
        ...
        XCTAssertEqual(
            renderNode.seeAlsoSections.first?.identifiers.sorted(),
            [
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-33vaw",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/init()-3743d",
                "doc://org.swift.docc.example/documentation/MyKit/MyClass/myFunction()",
    ...
    func testMediaReferencesWithSpaces() async throws {
        ...
        XCTAssertEqual(
            ["project.zip", "Xcode X.Y Beta Z", "with spaces.png", "with spaces.mp4"].sorted(),
    ...
    func testCompileSymbolMetadata() async throws {
        ...
        XCTAssertEqual(
            renderNode.metadata.modules?.map({ module -> String in
                return module.name
            }), ["MyKit"])
    ...
    func testArticleRoleHeadings() async throws {
        try await assertRoleHeadingForArticleInTestBundle(
            expectedRoleHeading: "Article",
            content: """
                # Article 2
    ...
    */
    ...
    func testWarnForExternalLinksInTopicTaskGroups() async throws {
        ...
        XCTAssertNotNil(
            context.diagnostics.first(where: { problem -> Bool in
    ...
    func testRendersBetaViolators() async throws {
        ...
        do {
            ...
            let (context, reference) = try await makeTestBundle(
                currentPlatforms: [
    ...
    func testRenderManualSeeAlsoInArticles() async throws {
        ...
        guard let seeAlso = renderNode.seeAlsoSections.first,
            ...
            let link = renderNode.references[seeAlsoLinkReference] as? LinkReference
        else {
    ...
    func testSafeSectionAnchorNames() async throws {
        ...
        XCTAssertNotNil(
            renderNode.primaryContentSections.first { section -> Bool in
                guard section.kind == .content,
                    let contentSection = section as? ContentRenderSection,
                    !contentSection.content.isEmpty
                else { return false }
    ...
    func testDisabledDocInheritance() async throws {
        ...
        XCTAssertFalse(
            missingResources.contains(where: { p -> Bool in
    ...
    func testEnabledDocInheritance() async throws {
        ...
        XCTAssertFalse(
            context.diagnosticEngine.diagnostics.contains(where: { problem in
    ...
    func testLanguageSpecificTopicSections() async throws {
        ...
        XCTAssertEqual(
            swiftTopicSection.first?.identifiers,
            [
        ...
        XCTAssertEqual(
            objcTopicSection.first?.identifiers,
            [
    ...
    func testLanguageSpecificTopicSectionDoesNotAppearInAutomaticSeeAlso() async throws {
        let catalog = Folder(
            ...
            content: [
                JSONFile(
                    name: "Something-swift.symbols.json",
                ...
                JSONFile(
                    name: "Something-objc.symbols.json",
                    content: makeSymbolGraph(
                        moduleName: "Something",
                        symbols: (1...4).map {
        ...
        func assertExpectedTopicSections(_ renderNode: RenderNode, file: StaticString = #filePath, line: UInt = #line) {
            ...
            XCTAssertEqual(
                swiftSeeAlsoSection.first?.identifiers,
                [
            ...
            XCTAssertEqual(
                objcSeeAlsoSection.first?.identifiers,
                [
                    "doc://Something/documentation/Something/SomeClass2",
    ...
    func testTopicSectionWithUnsupportedDirectives() async throws {
        ...
        XCTAssertEqual(
            topicSection.first?.identifiers,
            [
    ...
    func testAutomaticCurationForRefinedSymbols() async throws {
        ...
        do {
            ...
            XCTAssertEqual(
                swiftTopicSections.flatMap { [$0.title!] + $0.identifiers },
                [
                    "Structures",
            ...
            XCTAssertEqual(
                objcTopicSections.flatMap { [$0.title!] + $0.identifiers },
                [
                    "Structures",
                    "doc://GeometricalShapes/documentation/GeometricalShapes/Circle",
