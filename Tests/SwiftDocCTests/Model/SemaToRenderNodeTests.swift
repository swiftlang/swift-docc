...
class SemaToRenderNodeTests: XCTestCase {
    func testCompileTutorial() throws {
        ...
        XCTAssertEqual(problems.count, 1, "Found problems \(DiagnosticConsoleWriter.formattedDescription(problems)) analyzing tutorial markup")
    ...
    private func assertCompileOverviewWithNoVolumes(bundle: DocumentationBundle, context: DocumentationContext, expectedProblemsCount: Int = 0) throws {
        ...
        XCTAssertEqual(problems.count, expectedProblemsCount, "Found problems \(DiagnosticConsoleWriter.formattedDescription(problems)) analyzing tutorial markup")
    ...
    func testCompileOverviewWithVolumes() throws {
        ...
        XCTAssertEqual(problems.count, 0, "Found problems \(DiagnosticConsoleWriter.formattedDescription(problems)) analyzing tutorial markup")
