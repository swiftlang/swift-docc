...
class TopicGraphHashTests: XCTestCase {
    ...
    func testTopicGraphChangedHash() throws {
        ...
        let newNode = TopicGraph.Node(reference: .init(catalogIdentifier: #function, path: "/newSymbol", sourceLanguage: .swift), kind: .article, source: .external, title: "External Article")
    ...
    func testProducesTopicGraphHashWhenResolvedExternalReferencesInTaskGroups() throws {
        ...
        context.externalReferenceResolvers = ["com.external.testcatalog" : ExternalReferenceResolverTests.TestExternalReferenceResolver()]
        ...
        let myKitRef = ResolvedTopicReference(catalogIdentifier: catalog.identifier, path: "/documentation/MyKit", sourceLanguage: .swift)
