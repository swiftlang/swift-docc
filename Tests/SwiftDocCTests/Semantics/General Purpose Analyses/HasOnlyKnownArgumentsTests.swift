...
class HasOnlyKnownArgumentsTests: XCTestCase {
    ...
    func testInvalidArgumentsWithSuggestions() throws {
        ...
        XCTAssertEqual("error: Unknown argument 'baz' in Intro. These arguments are currently unused but allowed: 'bark', 'woof'.", DiagnosticConsoleWriter.formattedDescriptionFor(first.diagnostic))
    }
}
