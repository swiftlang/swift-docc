...
class HasAtMostOneTests: XCTestCase {
    func testEmpty() throws {
        ...
        directive.map { directive in
            ...
            let (match, remainder) = Semantic.Analyses.HasAtMostOne<TestParent, TestChild>().analyze(directive, children: directive.children, source: nil, for: catalog, in: context, problems: &problems)
            XCTAssertNil(match)
