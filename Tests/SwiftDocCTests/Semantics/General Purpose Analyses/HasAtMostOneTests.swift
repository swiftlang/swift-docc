...
class HasAtMostOneTests: XCTestCase {
    func testEmpty() async throws {
        ...
        directive.map { directive in
            ...
            let (match, remainder) = Semantic.Analyses.HasAtMostOne<TestParent, TestChild>(featureFlags: context.configuration.featureFlags).analyze(directive, children: directive.children, source: nil, for: context.inputs, problems: &problems)
            XCTAssertNil(match)
