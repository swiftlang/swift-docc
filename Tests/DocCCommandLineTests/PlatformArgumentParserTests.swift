...
class PlatformArgumentParserTests: XCTestCase {
    ...
    func testPlatformParsing() throws {
        XCTAssertEqual(
            try correctInputs.map(PlatformArgumentParser.parse),
            [
                //Expected output
        ...
        XCTAssertEqual(
            try betaInputs.map(PlatformArgumentParser.parse),
            [
                //Expected output
        ...
        XCTAssertEqual(
            try missingPatchInputs.map(PlatformArgumentParser.parse),
            [
                //Expected output
