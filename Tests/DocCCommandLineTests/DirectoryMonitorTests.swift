...
func fileURLsAreEqual(_ url1: URL, _ url2: URL) -> Bool {
    return url1.resolvingSymlinksInPath().standardizedFileURL.path == url2.resolvingSymlinksInPath().standardizedFileURL.path
}
#endif
...
class DirectoryMonitorTests: XCTestCase {
    ...
    func testMonitorUpdates() throws {
        ...
        try monitor(
            url: tempFolderURL, forChangeAtURL: updateURL.deletingLastPathComponent(), withDirectoryTreeReload: true,
            triggerBlock: {
        ...
        try monitor(
            url: tempFolderURL, forChangeAtURL: updateURL, withDirectoryTreeReload: false,
            triggerBlock: {
        ...
        // change url will be.
        try monitor(
            url: tempFolderURL, forChangeAtURL: nil, withDirectoryTreeReload: true,
            triggerBlock: {
        ...
        try monitor(
            url: tempFolderURL, forChangeAtURL: nil, withDirectoryTreeReload: false,
            triggerBlock: {
