...
class EmitGeneratedCurationsActionTests: XCTestCase {
    ...
    func testWritesDocumentationExtensionFilesToOutputDir() async throws {
        ...
        try await assertOutput(
            initialContent: [], depthLimit: 0, startingPointSymbolLink: nil,
            expectedFilesList: [
                "Output.doccarchive",
        ...
        try await assertOutput(
            initialContent: [], depthLimit: nil, startingPointSymbolLink: nil,
            expectedFilesList: [
                "Output.doccarchive",
        ...
        try await assertOutput(
            initialContent: [], depthLimit: nil, startingPointSymbolLink: "Foo-struct",
            expectedFilesList: [
                "Output.doccarchive",
                "Output.doccarchive/MixedLanguageFramework",
                "Output.doccarchive/MixedLanguageFramework/Foo-swift.struct.md",
