...
extension DocCHTMLTestSuites {
    struct HTMLFormatterTests {
        ...
        func prettyFormatsTagsOnTheirOwnLineAndTextInline() {
            ...
            #expect(
                htmlString(for: html, options: .prettyPrint) == """
                    <section>
                      <ul>
                        <li>First</li>
                        <li>Second</li>
        ...
        func prettyFormatsTextOnSeparateLineWhenContainerHasAttributes() {
            ...
            #expect(
                htmlString(for: html, options: [.prettyPrint, .omitOptionalQuotesAroundAttributeValues]) == """
                    <ul>
                      <li>Container without attribute</li>
                      <li id=something>
                        Container with attribute
        ...
        func prettyFormatsTextSemanticElementsOnSameNewLine() {
            ...
            #expect(
                htmlString(for: makeExample(paragraphAttributes: [.id("something")]), options: .prettyPrint) == """
                    <p id="something">
            ...
            #expect(
                htmlString(for: makeExample(paragraphAttributes: []), options: .prettyPrint) == """
                    <p>
                      Some <b>bold</b> and <i>italicized</i> text.
                    </p>
                    """)
        ...
        func prettyFormatsTextContentsInlineForAnchorElementWithSingleAttribute() {
            ...
            let anchorWithOnlyTextContents = h1(
                attributes: [.id("something")],
                contents: [
                    a(
            ...
            #expect(
                htmlString(for: anchorWithOnlyTextContents, options: .prettyPrint) == """
                    <h1 id="something">
                      <a href="#something">Some plain text</a>
                    </h1>
                    """)

            let anchorWithTwoAttributes = h1(
                attributes: [.id("something")],
                contents: [
                    a(
            ...
            #expect(
                htmlString(for: anchorWithTwoAttributes, options: .prettyPrint) == """
                    <h1 id="something">
            ...
            let anchorWithFormattedContents = h1(
                attributes: [.id("something")],
                contents: [
                    a(
                        attributes: [.href("#something")],
            ...
            #expect(
                htmlString(for: anchorWithFormattedContents, options: .prettyPrint) == """
                    <h1 id="something">
                      <a href="#something">
        ...
        func prettyFormatsTextContentsInlineForTableCellElementWithSingleAttribute() {
            ...
            #expect(
                htmlString(for: html, options: [.prettyPrint, .omitOptionalEndTags]) == """
                    <table>
                      <tr>
                        <td>No attribute
        ...
        func includesOptionalEndTagsByDefault() {
            ...
            #expect(
                htmlString(for: definitionList, options: .prettyPrint) == """
                    <dl>
                      <dt>range</dt>
                      <dd>
                        <p>
                    ...
                    """)
            #expect(
                htmlString(for: definitionList, options: [.prettyPrint, .omitOptionalEndTags]) == """
                    <dl>
                      <dt>range
                      <dd>
                        <p>
            ...
            #expect(
                htmlString(for: listOfLists, options: .prettyPrint) == """
                    <ul>
                      <li>First</li>
                      <li>Second</li>
                      <li>
                    ...
                    """)
            #expect(
                htmlString(for: listOfLists, options: [.prettyPrint, .omitOptionalEndTags]) == """
                    <ul>
                      <li>First
                      <li>Second
                      <li>
